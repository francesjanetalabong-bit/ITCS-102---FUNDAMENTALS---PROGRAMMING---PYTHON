...
def main_menu():
    while True : 
        ...
        choice = input("Enter your choiice (0-10):").strip()
...
def string_menu():
    while True:
        ...
        print("========================================================")
        print("1. Ask Name  Greet (act2)")
        print("2. Count characthers (act4)")
...
def arithmetic_menu():
    while True:
        ...
        print("========================================================")
        print("1. Basic Comptations (act6)")
...
def conditional_menu():
    while True:
        ...
        print("========================================================")
        print("1. Comparison and Booleans (act8)")
...
def dictionary_menu():
    while True:
        ...
        print("========================================================")
        print("1.Student information System (cc16)")
        print("0. Back to the Menu")
        print("========================================================")
...
def code_challenges_menu():
    while True:
        ...
        print("========================================================")
        print("1. Print your name in art (cc1)")
